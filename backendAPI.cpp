...
//             // Create a new rapidjson::Value for the decrypted code
//             rapidjson::Value decryptedCodeValue;
//             decryptedCodeValue.SetString(decryptedCode.c_str(), decryptedCode.size(), jsonDocument.GetAllocator());

//             (*itr)["code"].Swap(decryptedCodeValue);
...
//   // encryptedCode function to enc // unsigned char key[32];
//     // unsigned char iv[16]; // unsigned char key[32];
//     // unsigned char iv[16];rypt the plaintext
